...
export const themes: Record<string, Theme> = {
  ...
  christmas: {
    ...
    backgroundVideo: "/videos/christmas-background.mp4",
  },
  thanksgiving: {
    name: "Thanksgiving",
    id: "thanksgiving",
  ...
  stpatricks: {
    ...
    id: "stpatricks",
    primaryColor: "#9cfd7eff",
    secondaryColor: "#FFB81C",
    backgroundColor: "#0a3d1f",
    textColor: "#FFFFFF",
    accentColor: "#FFB81C",
    fontFamily: "'Irish Grover', 'Bangers', cursive",
    backgroundPattern: "radial-gradient(circle at 25% 35%, rgba(0, 140, 69, 0.15) 0%, transparent 50%), radial-gradient(circle at 75% 65%, rgba(255, 184, 28, 0.1) 0%, transparent 50%)",
    backgroundVideo: "/videos/patricksday-background.mp4",
  },
  default: {
    name: "Default",
    id: "default",
